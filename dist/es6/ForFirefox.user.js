...
// @updateURL   https://github.com/miaolapd/KF_Online_Assistant/raw/master/dist/es6/ForFirefox.meta.js
// @downloadURL https://github.com/miaolapd/KF_Online_Assistant/raw/master/dist/es6/ForFirefox.user.js
...
const modifyKFOtherDomainLink = exports.modifyKFOtherDomainLink = function () {
    $('.readtext a, .thread2 a').each(function () {
        ...
        let matches = /^(https?:\/\/(?:[\w\.]+?\.)?(?:2dgal|ddgal|9gal|9baka|9moe|kfgal|2dkf|ikfol|kfacg|fygal|bakabbs|365gal|365galgame|kforz|kfmax|miaola|koyuki)\.\w+?\/)\w+\.php/i.exec(url);
