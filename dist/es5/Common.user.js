...
var addFastNavMenu = exports.addFastNavMenu = function addFastNavMenu() {
    var $menuBtn = $('#alldiv > .drow:nth-child(2) > .dcol > .topmenuo > .topmenuo1 > .topmenuo3:last-child > a:contains("小游戏")');
 ...
 * 添加域名更换提示
 */
var showChangeDomainTips = exports.showChangeDomainTips = function showChangeDomainTips() {
